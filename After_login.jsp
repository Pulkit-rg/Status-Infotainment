                            ...
                            <lable for "comment">
                                <h4>Select a language: <h4>
                                    <select name="lang">
                                        ...
                                        <option name = py value="py">Python</option>
                            </lable>
...
%>        
                    ...
                    <div class="form-group row">
                        <div class="col-sm-7 ml-3">
                            <button style="color: black;transition-duration: 1s;border: 2px solid #006400;" class="btn btn-outline-success float-right" type="submit"> <b>Submit Your Code </b> </button>
                        </div>
                    </div>
                </form>
